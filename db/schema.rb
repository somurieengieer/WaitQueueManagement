...
ActiveRecord::Schema.define(version: 2019_01_12_021314) do
  ...
  create_table "wait_queues", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.integer "count"
    t.integer "admin_id"
    t.time "reset_time"
  ...
  create_table "waiters", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["wait_queue_id"], name: "index_waiters_on_wait_queue_id"
  end
